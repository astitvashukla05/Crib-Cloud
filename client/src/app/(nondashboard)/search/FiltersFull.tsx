...
const FiltersFull = () => {
  ...
  // added a small delay so router.push isn't spammed on fast input changes
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center">
            {/* FIX: bind to localFilters.location (was reading global filters before) */}
            <Input
        ...
        <div>
          ...
          <Slider
            ...
            className="bg-primary-700 rounded-lg"
          />
